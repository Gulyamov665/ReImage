...
#     TagsView
# )
from multi_upload import views
...
urlpatterns = [
    ...
    path("api/vendor/create", views.VendorView.as_view({"post":"create"}), name="vendor-create"),
    path("api/vendor/sticker", views.VendorView.as_view({"post":"sticker"}), name="vendor-sticker"),
    path("api/vendor/<str:name>", views.VendorView.as_view({"get":"download"}), name="vendor-download"),



    path("api/tags", views.TagsView.as_view({"get":"list"}), name="tags-path"),
